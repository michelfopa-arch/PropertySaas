...
namespace PropertySaaS.Infrastructure.Data
{
    ...
    public static class ApplicationDbSeeder
    {
        ...
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Organization>().HasData(new Organization { Id = orgId, Name = "Maple Leaf Property Group", Slug = "maple-leaf", Province = "ON", TimeZone = "America/Toronto", SubscriptionTier = SubscriptionTier.Growth, StripeCustomerId = "cus_demo_mapleleaf", StripeSubscriptionId = "sub_demo_mapleleaf", IsActive = true, CreatedUtc = new DateTime(2026,1,1,0,0,0,DateTimeKind.Utc) });
            modelBuilder.Entity<AppUser>().HasData(new AppUser { Id = Guid.Parse("66666666-6666-6666-6666-666666666666"), OrganizationId = orgId, ClerkUserId = "user_demo_owner", Email = "owner@mapleleafpm.ca", FullName = "Morgan Chen", Role = "Owner", IsActive = true, CreatedUtc = new DateTime(2026,1,1,0,0,0,DateTimeKind.Utc) });
            ...
            modelBuilder.Entity<ComplianceReminder>().HasData(
                new ComplianceReminder { Id = Guid.Parse("99999999-9999-9999-9999-999999999999"), OrganizationId = orgId, Title = "N1 rent increase notice window", NoticeType = "N1", DueDate = new DateOnly(2026,9,1), IsCompleted = false, Reference = "90 days notice recommended workflow", CreatedUtc = new DateTime(2026,1,1,0,0,0,DateTimeKind.Utc) },
                new ComplianceReminder { Id = Guid.Parse("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), OrganizationId = orgId, Title = "Standard Ontario Lease review", NoticeType = "SOL", DueDate = new DateOnly(2026,7,15), IsCompleted = false, Reference = "Ensure latest government template is attached", CreatedUtc = new DateTime(2026,1,1,0,0,0,DateTimeKind.Utc) });
