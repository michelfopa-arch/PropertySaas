...
{
    /// <inheritdoc />
    public partial class InitialRuntira : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RuntiraBlobArchives_RuntiraOrganizations_TenantId",
                        column: x => x.TenantId,
                        principalTable: "RuntiraOrganizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RuntiraConversations_RuntiraOrganizations_TenantId",
                        column: x => x.TenantId,
                        principalTable: "RuntiraOrganizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RuntiraJurisdictionProfiles_RuntiraOrganizations_TenantId",
                        column: x => x.TenantId,
                        principalTable: "RuntiraOrganizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RuntiraQuotaPolicies_RuntiraOrganizations_TenantId",
                        column: x => x.TenantId,
                        principalTable: "RuntiraOrganizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RuntiraWorkflowTemplates_RuntiraOrganizations_TenantId",
                        column: x => x.TenantId,
                        principalTable: "RuntiraOrganizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("aaaaaaaa-1111-2222-3333-bbbbbbbbbbbb"), "{\"tenantMode\":\"path\",\"archive\":\"blob\"}", "CA", new DateTime(2026, 7, 3, 0, 0, 0, 0, DateTimeKind.Utc), "fr-CA", true, "{\"jurisdiction\":\"AB\",\"supports\":[\"fr-CA\",\"en-CA\",\"es-MX\"]}", null, "Runtira Demo Alberta", "michelfopa@gmail.com", "AB", "demo-alberta", "America/Edmonton" });

            migrationBuilder.InsertData(
                table: "RuntiraUsers",
                columns: new[] { "Id", "ClerkUserId", "CreatedUtc", "Email", "FullName", "IsActive", "IsSuperAdmin", "ModifiedUtc", "PreferredLanguage" },
                values: new object[] { new Guid("cccccccc-1111-2222-3333-dddddddddddd"), "runtira_demo_owner", new DateTime(2026, 7, 3, 0, 0, 0, 0, DateTimeKind.Utc), "michelfopa@gmail.com", "Michel Fopa", true, true, null, "fr-CA" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("11111111-aaaa-bbbb-cccc-222222222222"), "{\"source\":\"seed\"}", "1180 17 Ave SW", "Property", "Calgary", "CA", new DateTime(2026, 7, 3, 0, 0, 0, 0, DateTimeKind.Utc), "{\"requiredQuestions\":[\"address\",\"period\",\"monthlyRent\"]}", null, "1180 17 Ave SW", "AB", new Guid("aaaaaaaa-1111-2222-3333-bbbbbbbbbbbb"), 12, "{\"status\":\"ready\"}" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("99999999-aaaa-bbbb-cccc-000000000000"), "demo-alberta/invoices/2026/07/invoice-july.json", "InvoiceDraft", "application/json", new DateTime(2026, 7, 3, 0, 0, 0, 0, DateTimeKind.Utc), "seed-demo-alberta-invoice", "{\"period\":\"2026-07\"}", null, 512L, "seed", new Guid("aaaaaaaa-1111-2222-3333-bbbbbbbbbbbb") });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("33333333-aaaa-bbbb-cccc-444444444444"), "Chat", new DateTime(2026, 7, 3, 0, 0, 0, 0, DateTimeKind.Utc), "CreateInvoice", "CA-AB", new DateTime(2026, 7, 3, 0, 0, 0, 0, DateTimeKind.Utc), "fr-CA", null, "Open", "Créer la facture mensuelle Alberta", "{\"nextQuestion\":\"Quel mois doit apparaître sur la facture PDF ?\"}", new Guid("aaaaaaaa-1111-2222-3333-bbbbbbbbbbbb") });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("12121212-aaaa-bbbb-cccc-343434343434"), "{\"supportsMultiUnit\":true}", "CA", new DateTime(2026, 7, 3, 0, 0, 0, 0, DateTimeKind.Utc), "{\"generatePdf\":true,\"addAutomaticGst\":false}", "{\"supportInboxClassification\":true}", null, "AB", "[\"propertyAddress\",\"billingPeriod\",\"monthlyRent\"]", "[\"fr-CA\",\"en-CA\",\"es-MX\"]", new Guid("aaaaaaaa-1111-2222-3333-bbbbbbbbbbbb"), "{\"billingPeriod\":{\"required\":true}}" });

            migrationBuilder.InsertData(
                table: "RuntiraMemberships",
                columns: new[] { "Id", "CreatedUtc", "LastSelectedUtc", "ModifiedUtc", "Role", "Status", "TenantId", "UserId" },
                values: new object[] { new Guid("eeeeeeee-1111-2222-3333-ffffffffffff"), new DateTime(2026, 7, 3, 0, 0, 0, 0, DateTimeKind.Utc), null, null, "Owner", "Active", new Guid("aaaaaaaa-1111-2222-3333-bbbbbbbbbbbb"), new Guid("cccccccc-1111-2222-3333-dddddddddddd") });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("56565656-aaaa-bbbb-cccc-787878787878"), new DateTime(2026, 7, 3, 0, 0, 0, 0, DateTimeKind.Utc), true, 50, 100, 2048, 1000, 5000, null, new Guid("aaaaaaaa-1111-2222-3333-bbbbbbbbbbbb") });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("77777777-aaaa-bbbb-cccc-888888888888"), new DateTime(2026, 7, 3, 0, 0, 0, 0, DateTimeKind.Utc), "Collecte les champs requis et prépare une facture PDF envoyable sans GST automatique.", true, null, "Create Alberta invoice PDF", "Demande l'adresse du bien, le mois/période et le montant avant génération.", "[\"propertyAddress\",\"billingPeriod\",\"monthlyRent\"]", new Guid("aaaaaaaa-1111-2222-3333-bbbbbbbbbbbb"), "CreateInvoice", "{\"monthlyRent\":{\"min\":1}}" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("55555555-aaaa-bbbb-cccc-666666666666"), "User", "Crée la facture PDF de juillet pour le 1180 17 Ave SW.", new Guid("33333333-aaaa-bbbb-cccc-444444444444"), "michelfopa@gmail.com", new DateTime(2026, 7, 3, 0, 0, 0, 0, DateTimeKind.Utc), "Incoming", null, true, "{\"intent\":\"CreateInvoice\"}", new Guid("aaaaaaaa-1111-2222-3333-bbbbbbbbbbbb") });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RuntiraBlobArchives_TenantId",
                table: "RuntiraBlobArchives",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_RuntiraConversations_TenantId",
                table: "RuntiraConversations",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_RuntiraJurisdictionProfiles_TenantId",
                table: "RuntiraJurisdictionProfiles",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_RuntiraMemberships_TenantId_UserId",
                table: "RuntiraMemberships",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RuntiraOrganizations_Slug",
                table: "RuntiraOrganizations",
                column: "Slug",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RuntiraQuotaPolicies_TenantId",
                table: "RuntiraQuotaPolicies",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_RuntiraUsers_Email",
                table: "RuntiraUsers",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RuntiraWorkflowTemplates_TenantId",
                table: "RuntiraWorkflowTemplates",
                column: "TenantId");
        }
