...
namespace Runtira.Infrastructure.Migrations
{
    ...
    [Migration("20260703130935_InitialRuntira")]
    partial class InitialRuntira
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Runtira.Domain.Entities.RuntiraConversation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Locale = "fr-CA",
                            Status = "Open",
                            Subject = "Créer la facture mensuelle Alberta",
            ...
            modelBuilder.Entity("Runtira.Domain.Entities.RuntiraJurisdictionProfile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CountryCode = "CA",
                            CreatedUtc = new DateTime(2026, 7, 3, 0, 0, 0, 0, DateTimeKind.Utc),
                            InvoiceRulesJson = "{\"generatePdf\":true,\"addAutomaticGst\":false}",
            ...
            modelBuilder.Entity("Runtira.Domain.Entities.RuntiraOrganization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DefaultLocale = "fr-CA",
                            IsActive = true,
                            LegalProfileJson = "{\"jurisdiction\":\"AB\",\"supports\":[\"fr-CA\",\"en-CA\",\"es-MX\"]}",
            ...
            modelBuilder.Entity("Runtira.Domain.Entities.RuntiraWorkflowTemplate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedUtc = new DateTime(2026, 7, 3, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Collecte les champs requis et prépare une facture PDF envoyable sans GST automatique.",
                            IsActive = true,
                            Name = "Create Alberta invoice PDF",
                            PromptTemplate = "Demande l'adresse du bien, le mois/période et le montant avant génération.",
                            RequiredQuestionsJson = "[\"propertyAddress\",\"billingPeriod\",\"monthlyRent\"]",
                            TenantId = new Guid("aaaaaaaa-1111-2222-3333-bbbbbbbbbbbb"),
