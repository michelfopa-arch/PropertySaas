    ...
    internal sealed class CosmosSeedService : IHostedService
    {
        ...
        private static IReadOnlyList<CosmosDocument> BuildSeedDocuments()
        {
            ...
            [
                ...
                CreateTenantDocument("asset", "87998799-aaaa-bbbb-cccc-879987998001", albertaTenantId, new Dictionary<string, object?> { ["name"] = "8799 Edgemont Link NW", ["assetType"] = "Property", ["addressLine1"] = "8799 Edgemont Link NW, Edmonton, AB T6M 3K7", ["city"] = "Edmonton", ["regionCode"] = "AB", ["countryCode"] = "CA", ["unitCount"] = 0, ["legalProfileJson"] = "{\"requiredQuestions\":[\"address\",\"period\",\"monthlyRent\"]}", ["additionalDataJson"] = "{\"source\":\"seed\",\"market\":\"Edmonton\",\"supportsMultiUnit\":false,\"assetName\":\"8799 Edgemont Link NW\",\"assetAddress\":\"8799 Edgemont Link NW, Edmonton, AB T6M 0P6\"}", ["workflowSummaryJson"] = "{\"status\":\"ready\"}", ["createdUtc"] = "2026-07-15T00:00:00Z", ["modifiedUtc"] = null }),
